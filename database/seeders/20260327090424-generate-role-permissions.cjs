...
module.exports = {
  async up(queryInterface, Sequelize) {
    ...
    await queryInterface.bulkInsert("role_permissions", [
      ...
      { role_id: 2, permission_id: 15 }, // View all files
      { role_id: 2, permission_id: 16 }, // Update own file
      { role_id: 2, permission_id: 17 }, // Update any file
      { role_id: 2, permission_id: 18 }, // Delete own file
      { role_id: 2, permission_id: 19 }, // Delete any file
      { role_id: 2, permission_id: 20 }, // Download own file
      // User (role_id = 3) Permissions
      { role_id: 3, permission_id: 2 }, // View own user data
      { role_id: 3, permission_id: 5 }, // Update own user data
      { role_id: 3, permission_id: 8 }, // Delete own user
      { role_id: 3, permission_id: 12 }, // Upload a file
      { role_id: 3, permission_id: 13 }, // View own file
      { role_id: 3, permission_id: 16 }, // Update own file
      { role_id: 3, permission_id: 18 }, // Delete own file
      { role_id: 3, permission_id: 20 }, // Download own file
    ]);
  },
